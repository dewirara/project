$(document).ready(function() {
  ...
  $(document).ready(function() {
    ...
    form.on("submit", function(e) {
      ...
      $.ajax({
        url: "includes/appoinment-submit.php", // form action url
  ...
  $(document).ready(function() {
    var form = $("#commentForm"); // contact form
    var submit = $(".com-submit-bt"); // submit button
    ...
    form.on("submit", function(e) {
      ...
      $.ajax({
        url: "includes/comment-submit.php", // form action url
        type: "POST", // form submit method get/post
        dataType: "html", // request type html/json/xml
        data: form.serialize(), 
        success: function(data) {
